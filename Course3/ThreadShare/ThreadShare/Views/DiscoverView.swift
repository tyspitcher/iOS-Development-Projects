                        ...
                        LazyVStack(alignment: .leading, spacing: 18) {
                            ...
                            if appState.filteredItems.isEmpty {
                                ...
                                DiscoverMasonryGrid(
                                    ...
                                    ownerForItem: appState.owner(for:),
                                    onDoubleTapLike: { item in
            ...
            HStack(spacing: 10) {
                ForEach(DiscoverFeedFilter.allCases) { filter in
                    FilterChip(
                        ...
                        isSelected: appState.discoverFilter == filter,
                        action: { appState.discoverFilter = filter }
                    )
                }
