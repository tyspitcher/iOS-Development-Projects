...
let runOne = RunningWorkout(distance: 100, time: 1200)
let runTwo = RunningWorkout(distance: 200, time: 2400)

struct SwimmingWorkout: Workout {
    var distance: Double
    var time: Double
}
let swimOne = SwimmingWorkout(distance: 1000, time: 600)
let swimTwo = SwimmingWorkout(distance: 2000, time: 1200)
...
simpleWorkoutDescription(workout: runOne)
simpleWorkoutDescription(workout: swimTwo)
/*:
