...
var shapes = ["Circle", "Triangle", "Rectangle"]
var colors = ["Blue", "Yellow", "Orange"]
let shapesAndColors : [String : [String]] = ["Shapes" : shapes, "Colors" : colors]
...
if let colors = shapesAndColors["Colors"], let lastColor = colors.last {
    print(lastColor)
}
