...
var currentUser = User(userName: "jibjab187", email: "jibjab4pres@gmail.com", age: 16)
print("user: \(currentUser.userName), email: \(currentUser.email), age: \(currentUser.age)")
 ...
 */
var anotherUser = User(userName: "titimepregunto", email: "badbunnypr@gmail.com", age: 33)
logIn(user: anotherUser)
/*:
