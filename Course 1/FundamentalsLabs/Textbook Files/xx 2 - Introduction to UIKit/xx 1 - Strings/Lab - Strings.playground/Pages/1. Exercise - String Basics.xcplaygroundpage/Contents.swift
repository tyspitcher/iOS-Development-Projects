 ...
 */
let favoriteQuote = "My favorite quote is \"It's the imperfections that make something beautiful, that's what makes it different and unique from everything else\"."
print(favoriteQuote)
print()
