...
var friendsNFamily = ["John", "Ringo", "Paul", "George"]
let sortedCollection1 = friendsNFamily.sorted(by: forwards)
...
//let comparison = { (name1: String, name2: String) -> Bool in
//    print(name1)
//    print(name2)
//    return name1 < name2
//}
//
//let sortedCollection2: [String] = friendsNFamily.sorted(by: comparison)
//print(sortedCollection2)
let sortedCollection2 = friendsNFamily.sorted { (name1, name2) -> Bool in
    return name1 < name2
}
print(sortedCollection2)
print()
...
let sortedCollection3 = friendsNFamily.sorted(by: {$0 < $1})
