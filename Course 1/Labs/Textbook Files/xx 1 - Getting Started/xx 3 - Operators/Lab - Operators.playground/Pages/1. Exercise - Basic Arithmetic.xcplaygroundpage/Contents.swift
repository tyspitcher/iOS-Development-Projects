...
print("I expect the integer division of 10/3 to be 3 because it's going to round to the nearest whole number.")
print()
let integerDivisionResultes = 10 / 3
print(integerDivisionResultes)
print()
...
// *** could alternatively use: let double10 = 10.0
let divisionResult = double10 / double3
print(divisionResult)
print()
// The result is different because when you divide a
// double you will get an answer that is accurate to a
// decimal level, not just whole numbers.
/*:
...
let circumgerence = 2 * pi * radius
print("The diameter is \(diameter), and the radius is \(radius).")
print()
//:  Create an integer constant. Using the modulus operator, set its value to the remainder of 12 divided by 5.
let modulusOperator = 12 % 5
print(modulusOperator)
print()
