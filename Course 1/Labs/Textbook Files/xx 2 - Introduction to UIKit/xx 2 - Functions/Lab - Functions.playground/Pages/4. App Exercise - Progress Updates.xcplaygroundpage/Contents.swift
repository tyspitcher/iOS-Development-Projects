 ...
 */
func progressUpdate (steps: Int, goal: Int) -> Bool {
    switch true {
    case steps < goal / 10 :
        print("You're off to a good start.")
    case steps < goal / 2 :
        print("You're almost halfway there!")
    case steps < (goal / 10) * 9:
...
progressUpdate(steps: 5_500, goal: 12_000)
progressUpdate(steps: 5_500, goal: 6_000)
progressUpdate(steps: 1_000, goal: 1_100)
progressUpdate(steps: 1_000, goal: 12_000)
...
pacing(currentDistance: 3, totalDistance: 30, currentTime: 12, goalTime: 100)
pacing(currentDistance: 3, totalDistance: 30, currentTime: 12, goalTime: 121)
/*:
