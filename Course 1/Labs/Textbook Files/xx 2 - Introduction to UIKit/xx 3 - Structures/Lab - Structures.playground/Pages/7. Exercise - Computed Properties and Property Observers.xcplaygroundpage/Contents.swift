...
var table = Rectangle(width: 39, height: 74)
print(table.area)
/*:
...
var growingBoy = Height(heightInCentimeters: 134)
print(growingBoy.heightInInches)
growingBoy.heightInInches = 62
print(growingBoy.heightInCentimeters)
