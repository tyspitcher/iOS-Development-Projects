...
func checkAge(userAge : String) -> Int? {
    if let userAge = Int(userAge) {
        return userAge
    } else {
       return nil
    }
}
print(checkAge(userAge: "19e"))

// this function will always return something, even
// if the value is nil
...
func purchase(itemName item : String) -> Double? {
...
print(purchase(itemName: "Donuts"))
print(purchase(itemName: "Juice"))
/*:
